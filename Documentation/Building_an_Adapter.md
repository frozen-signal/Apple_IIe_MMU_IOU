# TL;DR
Use a 5v CPLD. If in doubt, use the Altera EPM7128STC. The MMU don't need anything special, besides decoupling capacitors and programming pins. The IOU need the same things, plus a 10K pull-up resistor on /RESET.

# CPLD / FPGA Selection
## Device voltage
The Apple IIe being a 5v computer, using a 5v CPLD/FPGA will obviously be easier. Unfortunately, almost all CPLDs/FPGAs nowadays are 3.3v and will need the Apple's 5v to be level-shifted down to 3.3v. This is of course more complex, and some details about this can be found [here](# Using 3.3v)
...
# Hold Times
Some signal need to hold their value for a certain time. For example, see [DRAM hold times](/CUSTOM/DRAM_HOLD_TIME/readme.md). This implementation currently only offers the delays through Altera's LCELL buffers.<br/>
